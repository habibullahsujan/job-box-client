...
const CandidateRegistration = () => {
  ...
  const [registerCandidate, {isError, isLoading}]=useRegisterMutation();
  ...
  const onSubmit = (data) => {
    registerCandidate({...data, role:'candidate', email:email})
  };
      ...
      <div className='flex justify-center items-center overflow-auto p-10'>
        ...
        >
          ...
          <div className='flex flex-col w-full max-w-xs'>
            ...
            <input disabled={true} type='email' id='email' defaultValue={email} {...register("email")} />
          </div>
          <div className='flex flex-col w-full max-w-xs'>
