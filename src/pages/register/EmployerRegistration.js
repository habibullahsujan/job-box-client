...
const EmployerRegistration = () => {
  ...
  const [registerEmployee, {isError, isLoading}]=useRegisterMutation()
  ...
  const onSubmit = (data) => {
    registerEmployee({...data, role:'employer', email:email})
  };
  ...
  return (
    <div className=''>
      ...
      <div className='flex justify-center items-center overflow-auto p-10'>
        <form
          className='bg-gray-500 shadow-lg p-10 rounded-2xl flex flex-wrap gap-3 max-w-3xl justify-between'
        ...
        >
          ...
          <div className='flex flex-col w-full max-w-xs'>
            ...
            <input disabled={true} type='email' id='email' defaultValue={email} {...register("email")}  className="cursor-not-allowed"/>
          </div>
          <div className='flex flex-col w-full max-w-xs'>
          ...
          <div className='flex justify-between items-center w-full mt-3'>
            ...
            <button disabled={!term} className='bg-blue-600 border-none px-4 py-1 text-white rounded-md' type='submit'>
              Submit
            </button>
          </div>
        </form>
